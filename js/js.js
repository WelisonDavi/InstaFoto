...
window.onload=function(){
	...
	{
		navigator.notification.alert('Digite um email válido!','','Mensagem');
        $("#cad_email").focus();
        ...
        $.ajax({
            url:'https://welisondavi.com.br/phonegap/servidor/servidor/verificaEmail.php',
            dataType:'json',
            type:'POST',
            ...
            success: function(r){
                ...
                if (r.Resp==1) {
                    $("#mensagem").html("Este email já está sendo utilizado.");
                    $("#btnCadastrar").attr('disabled','disabled');
                }
                
                else if(r.Resp==0) {
                    $("#mensagem").html("E-mail disponível!")
            ...
            error:function(){
                navigator.notification.alert('Não foi possível conectar com o banco de dados!','','Erro');
                $("#btnCadastrar").attr('disabled','disabled');
            }
        })
    }
...
function verificaUsuario(){
    $.ajax({
        url:'https://welisondavi.com.br/phonegap/servidor/servidor/consultaUser.php',
        dataType:'json',
        type:'POST',
...
function inicio(){
    ...
    var foto = "<img class=foto src=https://welisondavi.com.br/phonegap/servidor/servidor/uploads/" + Perfil + " width=80%>";
    
    var nome = "Olá, " + Nome + "<br><br>";
...
function publicacoes(){
    $.ajax({
        url:'https://welisondavi.com.br/phonegap/servidor/servidor/consultaPostagens.php',
        dataType:'json',
        success: function(r) {
            //console.log(r);
            var total = r.length;
            ...
            for(i=0;i<total;i++){
                ...
                postagens+="<div style='width=100%;text-align:center;margin-top:20px'><img class='perfil' src='https://www.welisondavi.com.br/phonegap/servidor/servidor/uploads/" + r[i].img_user + "'>";
                postagens+="<br>" + r[i].usuario + "</div>";
                postagens+="<div style='width:100%'><img src='https://www.welisondavi.com.br/phonegap/servidor/servidor/uploads/" + r[i].imagem + "' width=100%></div>";
...
var ft = new FileTransfer();
 ft.upload(foto, "https://welisondavi.com.br/phonegap/servidor/servidor/publica.php", function(){
     $("#foto").hide();
     publicacoes();
 }, function(){
...
function respostaExc(r){  
    ...
    $.ajax({
        url:'https://welisondavi.com.br/phonegap/servidor/servidor/excluir.php',
        dataType:'json',
        type:'POST',
        data:{id:registro},
...
function cadastraUsuario(){
    ...
    if($("#cad_nome").val()=="" || $("#cad_email").val()=="" ||  $("#cad_senha").val()=="" || foto==null) {
        ...
        navigator.notification.alert('Todos os campos são obrigatórios!','','Erro');
    }else {
        ...
        var ft = new FileTransfer();
         ft.upload(foto, "https://welisondavi.com.br/phonegap/servidor/servidor/insereUser.php", function(){
